                ...
                <ul class="rating-list">
                    <li v-for="(comment,index) in selectComments" :key="index" class="comment-item">
                        ...
                        <div class="comment-main">
                            ...
                            <div class="pic" v-for="pic in comment.comment_pics" v-if="comment.comment_pics.length">
                                <img :src="pic.url" alt="" style="width: 80px;height: 80px;float: left;margin:0 3px  0 0">
                            </div>
                        </div>
                    </li>
                </ul>
...
<style scoped>
    ...
    .ratings .ratings-wrapper .content .rating-list .comment-item .comment-main .content {
        font-size: 13px;
        line-height: 19px;
        float: left;
        width: 100%;
    ...
    .ratings .ratings-wrapper .content .rating-list .comment-item .comment-main .content i {
        color: #576b95;
    }
