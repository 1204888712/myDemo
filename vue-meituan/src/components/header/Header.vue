<template>
    <div class="header">
        ...
        <div class="bulletin-wrapper">
            <!-- <div class="discounts" v-if="poiInfo.discounts2" v-for="discount in poiInfo.discounts2">
                <img class="icon" :src="discount.icon_url" />
                <span class="text">{{discount.info}}</span>
            </div> -->
                ...
                <div class="detail-wrapper">
                    ...
                    <div class="main-wrapper" :style="detail_bg">
                        ...
                        <div class="discounts" v-if="poiInfo.discounts2">
                            <p></p>
                            <div class="discount-list" v-for="discount in poiInfo.discounts2" style="text-align:left;padding:0 0 0 20px;">
